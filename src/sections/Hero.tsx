      ...
      <div className="container mx-auto px-4">
        <div className="md:flex items-center">
          ...
          <div className="mt-20 md:mt-0 md:h-[648px] md:flex-1 relative">
            ...
            <Image src={cylinder} width={220} height={220} alt="cylinder image" className="hidden md:block -top-8 -left-32 md:absolute"></Image>
            <Image src={noodle} width={220} className="hidden lg:block absolute top-[524px] left-[448px] rotate-[30deg]" alt="noodle image"></Image>
          </div>
        </div>
      </div>
    </section>
